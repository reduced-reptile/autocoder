  ...
  fs.readFile(path.join(__dirname, xmlFilePath), 'utf-8', function (error, xml) {
    ...
    parseString(xml, function (err, result) {
      ...
      res.render('index', {
        ...
        language: utils.getProperty('language_code', stringResources, req, res),
        welcomeMessage:utils.getProperty('welcome_message', stringResources, req, res),
        languageLink: utils.getProperty('language_link', stringResources, req, res),
        languageHref: utils.getProperty('language_href', stringResources, req, res),
